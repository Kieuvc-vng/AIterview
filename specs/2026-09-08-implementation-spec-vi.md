...
- [ ] HR chọn 1-5 kỹ năng (hoặc dùng gợi ý của AI)
...
- [ ] Ứng viên mở link → thấy thông điệp welcome
- [ ] Với mỗi câu hỏi:
  - [ ] AI hỏi câu hỏi
...
**Bước 3: Chọn số lượng kỹ năng**
- Radio buttons: 1 · 2 · 3 · 4 · 5 kỹ năng
- Mặc định: AI gợi ý (ví dụ "Chúng tôi gợi ý 3 kỹ năng cho công việc này")
- Nút: "Tiếp tục"
- **Trạng thái:**
  - Mặc định: AI gợi ý được chọn
  - Tùy chỉnh: người dùng chọn số khác
  - Đang xử lý: "Đang tạo gợi ý kỹ năng..."
...
### Màn hình 2: Candidate Interview (Chat)

**URL:** `/interview/{SESSION_ID}`

**Layout:**
- Header: "Phỏng vấn [Tên công việc]" (tên công việc từ setup)
- Khu chat (có thể scroll):
  - Tin đầu tiên (AI): "Xin chào! Tôi sẽ phỏng vấn bạn cho vị trí [Tên công việc]. Bắt đầu thôi. [Câu hỏi đầu tiên]"
...
- Input: Text JD + số lượng kỹ năng
- Quá trình: Gọi Qwen API: "Gợi ý {num_skills} kỹ năng để đánh giá cho vị trí {level} {job_title}"
- Output: Danh sách kỹ năng
...
2. Chờ câu trả lời của ứng viên.
...
4. Nếu câu trả lời tốt:
   - Phát biểu tích cực.
   - Kết thúc bằng: [[ANSWER_GOOD]]
5. Nếu câu trả lời yếu VÀ lần hỏi < 3:
...
5. **Testing:** Dùng fake data (fake JD, fake câu trả lời) — KHÔNG BÀNG dữ liệu thật
6. **Logging:** Ghi nhật ký sự kiện quan trọng (session tạo, phỏng vấn bắt đầu, lỗi) để debug

---

**Hết Implementation Spec**
